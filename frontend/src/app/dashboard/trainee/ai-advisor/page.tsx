      ...
      <div className="main-content bg-slate-50">
        <div className="page-header">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Your skills. Your next opportunity. Powered by Gemini AI.</p>
          </div>
          <div className="flex items-center gap-2">
            <div className="badge badge-purple text-xs">GEMINI AI</div>
        ...
        <div className="page-body">
          ...
          <div className="mb-5 p-3 rounded-xl border flex items-start gap-2 text-sm"
            ...
            <span>AI recommendations are generated by Google Gemini based on your skill profile and available job market data. AI suggestions are for guidance only and do not guarantee employment outcomes.</span>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div className="card flex flex-col" style={{ height: 440 }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-slate-800 text-sm">Ask Gemini</h3>
                ...
                <div ref={chatRef} className="flex-1 overflow-y-auto flex flex-col gap-2 mb-3 pr-1">
                  {messages.map((msg, i) => (
                    <div key={i} className={msg.role === 'user' ? 'self-end' : 'self-start'}>
                      {msg.role === 'assistant' && (
                        <div className="text-[10px] text-slate-400 mb-0.5 ml-1">Gemini AI</div>
                      )}
              ...
              <div className="card card-sm">
                ...
                {[
                  ...
                  <button key={a.label} className="w-full btn btn-sm mb-1.5 justify-start" style={{ color: a.color, border: `1px solid ${a.color}30`, background: `${a.color}08` }}>
                    {a.icon} {a.label}
                  </button>
                ))}
